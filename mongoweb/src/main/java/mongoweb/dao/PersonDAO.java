...
import mongoweb.converter.PersonConverter;
import mongoweb.model.Person;
...
public class PersonDAO 
{
	...
	public PersonDAO(MongoClient m) 
	{
		this.col=m.getDB("mongowebdb").getCollection("Person");
	}
